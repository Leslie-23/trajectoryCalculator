...
void displayProjectileMotion(double initialVelocity, double launchAngle, double gravity, double timeInterval) {
    const int maxHeight = 20;  // Maximum height for display
    const int timeIntervals = 30;  // Number of time intervals
...
int main() {
    const double initialVelocity = 20.0;  // Initial velocity in m/s
